...
public class MFastExcelGenerator {
    public static void main(String[] args) throws Exception {
        long startTime = System.currentTimeMillis();

        XSSFWorkbook workbook = new XSSFWorkbook(); // keep 5000 rows in memory, others are flushed to disk
        ...
        for (int rowNum = 1; rowNum <= 1_0_000; rowNum++) {
        ...
        workbook.close(); // important to avoid memory leaks

        long endTime = System.currentTimeMillis();
        System.out.println("Excel generation completed in " + (endTime - startTime) + " ms");
    }
